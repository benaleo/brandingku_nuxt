...
export default defineNuxtConfig({
  ...
  modules: [
    ...
    '@nuxt/icon',
    '@nuxtjs/apollo',
    // Always include NuxtHub; it is no-op locally and required for NuxtHub deploys
    '@nuxthub/core'
  ],

  nitro: {
    // Default to a Cloudflare-compatible preset for NuxtHub; can be overridden via env
