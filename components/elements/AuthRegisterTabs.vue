<template>
  <div class="w-full min-h-[50vh] flex gap-4">
    <div class="group relative bg-green-100 hidden md:flex flex-col justify-center items-start flex-1 overflow-hidden rounded-bl-4xl">
    ...
    <div class="flex-1 justify-center pt-4">
      <RegisterForm/>
    </div>
  </div>
</template>
